...
export default function CategoryPage() {
  ...
  console.log("navigate : ", navigate.slug);
  ...
  useEffect(() => {
    ...
    kakaoMapScript.src = `//dapi.kakao.com/v2/maps/sdk.js?appkey=45261002ace2614c49bbf17f762fa1ba&autoload=false&libraries=LIBRARY&libraries=services&libraries=services,clusterer,drawing`;
